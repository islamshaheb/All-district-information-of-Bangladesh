...
void place(struct district ma[],int n)
{
     ...
     if(k==1)printf("A%s %s %f ll historical name of This district %s\n",ma[pdx].place);
     else printf("Search Not Found\n");
}
...
//    char ch[10];
    ...
    if(k==1)printf("The amount of people This district %d\n\n\n",ma[pdx].people);
    else printf("Search Not Found\n");
}
void density(struct district ma[],int n)
{
    ...
    if(k==1)printf("The density of This district %d(sq)KM\n\n\n",ma[pdx].density);
    else printf("Search Not Found\n");
}
